...
def main(args):
    ...
    # Initialize training accelerator (handles multi processing)
    ...
    # Use 8-bit Adam for lower memory usage or to fine-tune the model in VRAM GPUs
    ...
    def compute_embeddings(
        ...
        prompt_embeds, pooled_prompt_embeds, syn_or_real = encode_prompt(
    ...
    train_dataset_original = get_train_dataset(args, accelerator, logger)
    ...
    with accelerator.main_process_first():
        ...
        train_dataset_original = train_dataset_original.map(
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        # Repeat the preprocessing preparation to generate different instances (different random operations)
        train_dataset = prepare_train_dataset(args, train_dataset_original, accelerator)
